...
Desktop interface for Lab 2 hydraulic control, built with PyQt6.

This app connects to the ESP32-S3 firmware (Sprint 5), sends commands, receives telemetry, and shows live plots/logs for operation, characterization, and calibration.

## 1. Requirements

- Python 3.10+ (tested with 3.13)
- ESP32-S3 firmware loaded (Sprint 5)
- USB serial connection to board
...
The app opens with a sidebar and 5 main pages:
